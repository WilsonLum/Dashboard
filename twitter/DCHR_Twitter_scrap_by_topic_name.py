...
# Logging information
logFileName = 'log\DCHR_Twitter_By_Topic_info.log'
...
logging.info("*****************************************************")
logging.info("Scrapping By Topic Twitter at " + str(d))
logging.info("*****************************************************")
...
lineList = list()
try:
    config_filename = "input\Twitter By Topic List.txt"
        ...
        try:
            ...
            for tweet in new_tweets:
                my_tweets.append([tweet.created_at, tweet.full_text,tweet.favorite_count,tweet.retweet_count,
                                  ...
                                  tweet.user.profile_image_url,tweet.user.screen_name,tweet.entities,search_query])
...
header = ['Date', 'Text','favorite_count', 'retweet_count', 'url', 'followers_count', 'background_image_url',
          'profile_image_url','screen_name', 'entities_url','ticker']
all_df = pd.DataFrame()
...
print("Saving data to DCHR_Twitters_by_topics .... ")
logging.info("Saving data to DCHR_Twitters_by_topics .... ")

writer1 = pd.ExcelWriter('data\DCHR_Twitters_by_topics.xlsx', engine='xlsxwriter')
all_df.to_excel(writer1, sheet_name= 'Topics', index=False)

# Close the Pandas Excel writer and output the Excel file.
writer1.save()

writer2 = pd.ExcelWriter('data\DCHR_Twitters_by_topics_' + d + '.xlsx', engine='xlsxwriter')
