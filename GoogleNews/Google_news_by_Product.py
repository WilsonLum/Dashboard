...
# Logging information
logFileName = 'log\DCHR_Google_new_by_Product_' + d + '.log'
...
logging.info("*******************************************************************")
logging.info("Creating Google RSS News dataset by Product  at " + str(d))
logging.info("*******************************************************************\n")
...
lineList = list()
config_filename = "input\Google_search_Product.txt"
...
def read_file(topic,i):
	print("\n---------------------------------------------------\n")
	json_filename =  "data\\Product\\" + topic + ".json"
	df = pd.DataFrame()
...
writer1 = pd.ExcelWriter('data\DCHR_Google_Product.xlsx', engine='xlsxwriter')
...
# Create a new excel workbook
writer2 = pd.ExcelWriter('data\DCHR_Google_Product_' + d + '.xlsx', engine='xlsxwriter')
