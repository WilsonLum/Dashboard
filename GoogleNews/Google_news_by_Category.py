...
# Logging information
logFileName = 'log\DCHR_Google_new_by_Category_' + d + '.log'
...
logging.info("*******************************************************************")
logging.info("Creating Google RSS News dataset by Category  at " + str(d))
logging.info("*******************************************************************\n")
...
lineList = list()
config_filename = "input\Google_search_Category.txt"
...
def read_file(topic,i):
	print("\n---------------------------------------------------\n")
	json_filename =  "data\\Category\\" + topic + ".json"
	df = pd.DataFrame()
...
writer1 = pd.ExcelWriter('data\DCHR_Google_Category.xlsx', engine='xlsxwriter')
...
# Create a new excel workbook
writer2 = pd.ExcelWriter('data\DCHR_Google_Category_' + d + '.xlsx', engine='xlsxwriter')
